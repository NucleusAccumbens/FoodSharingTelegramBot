...
namespace FoodSharing.DataAccessLayer.Migrations
{
    ...
    [Migration("20220416183037_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodSharing.DataAccessLayer.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = 0,
                            ComandState = 0,
                            CreatedAt = new DateTime(2022, 4, 16, 18, 30, 37, 457, DateTimeKind.Utc).AddTicks(6021),
            ...
            modelBuilder.Entity("FoodSharing.DataAccessLayer.Entity.Food", b =>
                {
                    b.HasOne("FoodSharing.DataAccessLayer.Entity.User", "User")
                        .WithMany("Foods")
